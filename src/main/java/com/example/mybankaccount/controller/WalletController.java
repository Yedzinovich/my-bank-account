...
public class WalletController {
    ...
    @GetMapping("/api/v1/wallet/{walletId}/account/{accountId}/balance")
    ...
    @PostMapping("/api/v1/wallet/{walletId}/account/{accountId}/withdraw/{amount}")
    ...
    @PostMapping("/api/v1/wallet/{walletId}/account/{accountId}/deposit/{amount}")
    ...
    @PostMapping("/api/v1/wallet/{fromWalletId}/account/{fromAccountId}/transfer/wallet/{toWalletId}/account/{toAccountId}/amount/{amount}")
    ...
    @GetMapping("/api/v1/wallet/{walletId}/account/{accountId}/lastNTransactions/{n}")
